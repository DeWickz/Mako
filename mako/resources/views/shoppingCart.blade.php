                    ...
                    <tr class="table-row">
                        ...
                        <div class="btn-group dropup">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('reducebyone', $product['item']['id'])}}">Remove 1 item</a>
                                <a class="dropdown-item" href="{{route('removeitem', $product['item']['id'])}}">Remove all items</a>
                            </div>
                            </div>
                        </td>
